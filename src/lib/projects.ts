...
export const projects: Project[] = [
  ...
  project({
    ...
    location: "Национальный сад «Ирам»",
    country: "Таджикистан",
    area: "14 × 8 м",
    duration: "Полный цикл производства и монтажа",
    summary:
      "Монументальная беседка 14×8 м в Национальном саду «Ирам»: основной материал — ясень, художественная резьба и монтаж под ключ.",
    overview:
      "Беседка 14×8 м для Национального сада «Ирам» в Таджикистане: проектирование, производство из ясеня, станочная обработка, ручная доработка, художественная резьба, сборка и монтаж.",
    result:
      "Объект стал архитектурным акцентом сада «Ирам» — монументальная конструкция из ясеня с художественной резьбой.",
    scope: [
      "Проектирование",
      "Производство",
      "Станочная обработка",
    ...
    completedWorks: [
      "Каркас беседки 14×8 м",
      "Станочная обработка",
      "Ручная доработка",
      "Художественная резьба",
      "Сборка и монтаж на объекте",
    ],
    productionSteps: [
      "Станочная обработка",
      "Ручная доработка",
    ...
    installationSteps: ["Доставка", "Сборка на площадке", "Монтаж", "Финиш"],
    materials: ["Ясень"],
  }),
  project({
    slug: "walnut-daybed",
